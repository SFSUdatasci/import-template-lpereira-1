...
The ocean water plot above shows the Redfield ratio relationship. The most optimal nutrient ratio (N16+:P1+) is further down the plot, but shows how the nutrient levels are linear and proportional. The actual ratio from the data though, gave us a ratio of N6.2: P1, showing that the ocean location is not up to the Redfield framework. There are many factors that lead to nutrient depletion and more work would have to be done to determine why.
